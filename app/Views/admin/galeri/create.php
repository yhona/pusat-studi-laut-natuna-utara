...
<div class="space-y-6 max-w-4xl">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-xl font-extrabold text-navy-950">Tambah Dokumentasi Riset & Ekspedisi Baru</h2>
            <p class="text-xs text-slate-500 mt-1">Daftarkan foto dokumentasi, riset laut, atau pengujian laboratorium.</p>
        </div>
    ...
    <!-- Form -->
    <form action="<?= base_url('admin/galeri/store') ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div class="bg-white rounded-2xl p-6 sm:p-8 border border-slate-200 shadow-xs space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="title" required placeholder="Contoh: Ekspedisi Oseanografi Natuna Utara"
                ...
                <div>
                    ...
                    <select name="category" required class="w-full text-xs rounded-xl border border-slate-300 p-2.5 bg-white">
                        <option value="ekspedisi">Ekspedisi Laut</option>
            ...
            <div>
                ...
                <input type="text" name="title_en" placeholder="North Natuna Oceanographic Expedition"
                       class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="date_text" required placeholder="Contoh: 12 - 25 November 2025"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">
                    ...
                    <input type="text" name="date_text_en" placeholder="Contoh: 12 - 25 November 2025"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="location" required placeholder="Contoh: Laut Natuna Utara (Wilayah ZEE Indonesia)"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">
                    ...
                    <input type="text" name="location_en" placeholder="Contoh: North Natuna Sea (Indonesian EEZ Waters)"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="vessel" placeholder="Contoh: Kapal Riset Kolaboratif UMRAH - BRIN"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">
                    ...
                    <input type="text" name="vessel_en" placeholder="Contoh: Collaborative Research Vessel UMRAH - BRIN"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="focal" placeholder="Contoh: Karakteristik Termoklin & Dinamika Arus Lapisan"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
                <div>
                    <label class="block text-xs font-bold text-slate-700 mb-1">
                    ...
                    <input type="text" name="focal_en" placeholder="Contoh: Thermocline Structure & Deep Layer Current Dynamics"
                           class="w-full text-xs rounded-xl border border-slate-300 p-2.5">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <textarea name="desc" rows="4" required placeholder="Deskripsi teknis instrumen dan metodologi..."
                ...
                <div>
                    ...
                    <textarea name="desc_en" rows="4" placeholder="Technical description in English..."
                              class="w-full text-xs rounded-xl border border-slate-300 p-2.5 leading-relaxed"></textarea>
                </div>
            </div>
            ...
            <div class="p-4 rounded-xl bg-slate-50 border border-slate-200/80 space-y-3">
                <span class="text-xs font-bold text-navy-950 block">Foto Dokumentasi</span>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
            ...
            <div class="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-xl bg-gold-500 hover:bg-gold-400 text-navy-950 text-xs font-bold shadow-md transition-all active:scale-[0.98]">
                    <i class="fa-solid fa-save mr-1.5"></i> Simpan Dokumentasi
                </button>
            </div>
        </div>
    </form>
